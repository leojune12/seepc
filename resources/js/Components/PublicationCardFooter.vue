<template>
    <div>
        ...
        <div class="flex py-1">
            <div
                class="h-9 rounded flex-1 md:cursor-pointer flex items-center justify-center"
                :class="[ inShowComponent ? 'md:hover:bg-gray-100 hover:bg-black' : 'hover:bg-gray-100' ]"
                @click="like"
            >
                <div
            ...
            <div
                class="h-9 rounded md:hover:bg-gray-100 focus:outline-none flex-1 flex items-center justify-center md:cursor-pointer"
                @click="showComments = true"
            >
                <div
                    class="flex"
